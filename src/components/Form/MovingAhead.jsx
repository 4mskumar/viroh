      ...
      <div className='mt-10 flex flex-col lg:flex-row justify-center items-center gap-8'>
        ...
        <SpotlightCard className='flex flex-col  items-center justify-center gap-3 p-6 min-w-[180px]'>
          ...
          <div className='text-center'>
            ...
            <p className='text-xs text-gray-200 mt-0.5'>We usually reply instantly</p>
          </div>
        ...
        <div className='flex lg:flex-col items-center gap-3'>
          <Separator className='w-16 lg:w-px lg:h-16' orientation='horizontal' />
        ...
        <div className='flex flex-col items-center gap-2'>
          <img className='object-cover h-[10rem] w-[10rem] rounded-xl shadow-md' src='/images/qr.jpeg' alt='QR Code' />
